const CACHE_NAME = "ipw-complaint-workspace-v17-grouped-labels-ui-library-release1-zm-pairs";
const APP_SHELL = [
  ...
  "../workspace/workspace-ui.js?v=4", "./workspace2.css?v=16", "./workspace2-ui.js?v=1",
