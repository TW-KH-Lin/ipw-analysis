const CACHE_NAME = "ipw-complaint-workspace-v18-cross-workbook-comparison";
const APP_SHELL = [
  ...
  "../workspace/workspace-ui.js?v=5", "./workspace2.css?v=19", "./workspace2-ui.js?v=2",
  "./workbook-comparison.js?v=1",
